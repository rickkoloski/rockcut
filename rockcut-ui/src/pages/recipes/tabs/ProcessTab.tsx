...
import type { Recipe, ProcessStep } from '../../../lib/types';

interface ProcessTabProps {
  recipe: Recipe;
}

export default function ProcessTab({ recipe }: ProcessTabProps) {
  const [dialogOpen, setDialogOpen] = useState(false);
  const [editItem, setEditItem] = useState<ProcessStep | undefined>();
  ...
  const steps: ProcessStep[] = recipe.process_steps ?? [];

  const columns: GridColDef<ProcessStep>[] = [
    ...
    { field: 'duration_unit', headerName: 'Unit', width: 100 },
