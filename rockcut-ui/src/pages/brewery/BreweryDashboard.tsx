...
export default function BreweryDashboard() {
  ...
  return (
    <Box>
      <PageHeader breadcrumbs={[{ label: 'Home', to: '/' }, { label: 'Brewery' }]} title="Brewery Dashboard" />
      ...
      <Paper elevation={0} sx={{ border: '1px solid', borderColor: 'divider', mb: 4 }}>
        <DataGridExtended
          ...
          columnVisibilityToggle={{ storageKey: 'rockcut:brewery:active-batches' }}
          autoHeight
      ...
      <Paper elevation={0} sx={{ border: '1px solid', borderColor: 'divider' }}>
        <DataGridExtended
          ...
          columnVisibilityToggle={{ storageKey: 'rockcut:brewery:recent-recipes' }}
          autoHeight
          disableRowSelectionOnClick
          onRowClick={(params) => {
