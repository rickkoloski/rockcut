defmodule RockcutApi.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: RockcutApi.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    RockcutApiWeb.Endpoint.config_change(changed, removed)
    :ok
  end
