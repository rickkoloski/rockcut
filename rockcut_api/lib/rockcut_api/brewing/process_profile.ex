defmodule RockcutApi.Brewing.ProcessProfile do
  ...
  def changeset(profile, attrs) do
    ...
    |> cast(attrs, [
      :name, :description,
      :mash_type, :mash_foundation_water, :strike_water_ratio, :mash_ph, :mash_schedule,
      :vorlauf_duration, :lauter_type, :lauter_temperature, :lauter_water, :final_lauter_ph, :lauter_duration,
      :boil_duration, :coolpool, :coolpool_temperature, :coolpool_duration, :coolpool_rest_duration,
      :whirlpool_duration, :whirlpool_rest_duration, :knockout_duration, :knockout_temperature,
      :lag_temperature, :lag_duration, :primary_temperature, :primary_duration,
      :secondary_temperature, :secondary_duration, :d_rest_temperature, :d_rest_duration,
      :crash_type, :crash_temperature, :crash_duration, :crash_steps,
      :transfer_type, :bright_temperature, :bright_duration, :co2_volume
    ])
